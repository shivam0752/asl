...
import { connectGoogleFit, fetchGoogleFitData } from '../../lib/googlefit';
  ...
  async function handleConnect() {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (accessToken && user) {
          ...
          const stats = calculateAllStats({
            avgDailySteps:      fitData.avgDailySteps,
            workoutDaysPerWeek: fitData.weeklyWorkouts,
            avgSleepHours:      fitData.avgSleepHours,
            yearsExperience:    2,  // will be updated from LinkedIn
          ...
          // Create character with real stats
        ...
        Alert.alert(
          'Connection Failed',
          result.error ?? 'Please try again or enter data manually.',
          [
      ...
      Alert.alert(
        ...
        'Would you like to enter your data manually instead?',
        [
          {
            text: 'Enter Manually',
            onPress: () => router.push('/(onboarding)/manual-entry'),
